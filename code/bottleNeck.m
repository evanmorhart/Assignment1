function bottleNeck(system, electron, numLoops, timeStep, boundType)
...
figure(3)
edense = hist3([electron.x(end,:)', electron.y(end,:)'], [50 25]);
pcolor(edense);
legend();
    
title("Diffusive Boundaries With Forbidden Regions, 1000 Cycles");
